...
if __name__ == '__main__':
    ...
    for dataset_name in os.listdir('Datasets//smaller_ones//'):    # dataset_name now contains the trailing '.csv'
        if(dataset_name.endswith('csv')):
            # Create files to write out the prints
            outfilename = "outputs//DT_d1//" + dataset_name[:-4] +"_summary.txt"    
            outfile = open(outfilename,"w")
            
            csvfilename = "outputs//DT_d1//" + dataset_name[:-4] +"_details.csv"     
